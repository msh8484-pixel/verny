...
export default function VValues() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(".value-item", { opacity: 0, y: 30 }, {
  ...
  return (
    <section
      ref={sectionRef}
      style={{ backgroundColor: "#0a1528", padding: "120px 40px", overflow: "hidden" }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        {/* 2열 레이아웃: 좌측 인용구 + 우측 패키징 사진 */}
        <div
          style={{
            display: "grid",
        ...
        >
          <div ref={quoteRef} style={{ opacity: 0 }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: "#C9A84C", letterSpacing: "0.3em", marginBottom: 32 }}>
              BRAND PHILOSOPHY
            </p>
            <p
              style={{
            ...
            <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", lineHeight: 1.9 }}>
              VERNY는 눈에 띄는 로고 대신 소재와 구조로 말합니다.
              신사 정장의 마지막 디테일을 완성하는 브랜드,
              그것이 VERNY가 존재하는 이유입니다.
            </p>
          </div>
        ...
        >
          {[
            {
              img: "/product-label.png",
              title: "국내 봉제 생산",
              desc: "국내 검증된 봉제 공장, MADE IN KOREA. 원산지와 소재 구성을 라벨에 정직하게 표기합니다.",
            },
            {
              img: "/shopping-bag.png",
              title: "정직한 사이즈",
              desc: "갑종 기준 250~280mm, 워싱 수축까지 적용된 실착용 사이즈입니다.",
            },
            {
              img: "/gift-set.png",
              title: "패키징도 제품입니다",
              desc: "네이비 박스와 골드 포일 로고. 선물용으로도 완벽한 VERNY 경험.",
            },
          ].map((v, i) => (
            <div
              key={v.title}
            ...
            >
              ...
              <div style={{ width: 20, height: 1, backgroundColor: "#C9A84C", marginBottom: 14 }} />
